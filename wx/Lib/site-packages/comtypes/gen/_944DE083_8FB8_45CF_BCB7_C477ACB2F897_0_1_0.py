...
__all__ = [
    ...
    'UIA_SeparatorControlTypeId', 'UIA_ProcessIdPropertyId',
    ...
    'UIA_AnnotationAuthorPropertyId', 'UIA_RangeValuePatternId',
    'ToggleState_On', 'UIA_Transform2ZoomMinimumPropertyId',
    'UIA_OutlineColorPropertyId', 'UIA_TextPatternId',
    'RowOrColumnMajor_Indeterminate', 'IUIAutomation6',
    'IUIAutomationProxyFactoryMapping', 'UIA_TextChildPatternId',
    'CUIAutomation8', 'UIA_TableColumnHeadersPropertyId',
    'LiveSetting', 'UIA_IsTransformPattern2AvailablePropertyId',
    'SynchronizedInputType_LeftMouseDown',
    'AutomationElementMode_Full', 'ToggleState', 'Assertive',
    'IUIAutomationBoolCondition',
    'UIA_IsStylesPatternAvailablePropertyId', 'AnnotationType_Footer',
    'IUIAutomationInvokePattern', 'SupportedTextSelection',
    ...
    'UIA_FillColorPropertyId', 'UIA_OutlineThicknessPropertyId',
    'SynchronizedInputType_LeftMouseUp',
    'UIA_TransformCanMovePropertyId', 'Library',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'ZoomUnit_LargeDecrement', 'UIA_StylesStyleIdPropertyId',
    'IUIAutomationSelectionPattern2', 'UIA_SemanticZoomControlTypeId',
    'NotificationKind_ActionAborted', 'StyleId_Heading7',
    ...
    'TextEditChangeType_AutoComplete', 'IUIAutomationElementArray',
    'UIA_MenuModeEndEventId', 'UIA_GridRowCountPropertyId',
    ...
    'WindowInteractionState_Closing', 'RowOrColumnMajor_ColumnMajor',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_WindowCanMaximizePropertyId', 'AnnotationType_MoveChange',
    'StyleId_Heading3', 'UIA_CultureAttributeId',
    'NotificationProcessing_MostRecent',
    'UIA_AnnotationDateTimePropertyId', 'UIA_DataGridControlTypeId',
    'IUIAutomationTogglePattern', 'UIA_TitleBarControlTypeId',
    'UIA_BoundingRectanglePropertyId', 'StyleId_Custom',
    'IUIAutomationStructureChangedEventHandler',
    'IUIAutomationChangesEventHandler', 'UIA_SelectionItemPatternId',
    'UIA_ItemContainerPatternId', 'IUIAutomationElement9',
    'UIA_CustomControlTypeId', 'IUIAutomationPropertyCondition',
    'UIA_AcceleratorKeyPropertyId', 'UIA_ForegroundColorAttributeId',
    'AnnotationType_SpellingError',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'NotificationProcessing_All', 'StyleId_Heading2',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'SynchronizedInputType_RightMouseUp', 'UIA_StylesShapePropertyId',
    'UIA_ObjectModelPatternId', 'IUIAutomationOrCondition',
    'UIA_ListItemControlTypeId', 'SupportedTextSelection_None',
    'IUIAutomationLegacyIAccessiblePattern', 'StyleId_Heading9',
    'UIA_GridItemContainingGridPropertyId',
    'UIA_IsKeyboardFocusablePropertyId', 'DockPosition_Bottom',
    'UIA_DropTarget_DragLeaveEventId', 'TreeTraversalOptions_Default',
    'HeadingLevel8', 'UIA_ScrollPatternId',
    'UIA_MarginTrailingAttributeId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_LineSpacingAttributeId', 'UIA_ToggleToggleStatePropertyId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'IRawElementProviderSimple', 'UIA_GridItemRowPropertyId',
    'UIA_WindowControlTypeId', 'UIA_TabsAttributeId',
    'IUIAutomationVirtualizedItemPattern', 'StyleId_Title',
    'UIA_TableRowOrColumnMajorPropertyId',
    'TextEditChangeType_AutoCorrect', 'IUIAutomationElement4',
    'UIA_MultipleViewPatternId', 'IAccessible', 'HeadingLevel_None',
    'UIA_LabeledByPropertyId',
    'TextEditChangeType_CompositionFinalized',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'IUIAutomationTextRange3', 'IUIAutomationScrollPattern',
    'IUIAutomationMultipleViewPattern', 'UIA_LandmarkTypePropertyId',
    'AutomationElementMode_None', 'UIA_SelectionPattern2Id',
    'IUIAutomation2', 'UIA_UnderlineStyleAttributeId',
    'UIA_HyperlinkControlTypeId', 'HeadingLevel2',
    'AnnotationType_FormatChange', 'IUIAutomationCacheRequest',
    'IUIAutomationTableItemPattern', 'UIA_TableControlTypeId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_BulletStyleAttributeId', 'StyleId_Heading8',
    'NavigateDirection_NextSibling',
    'AnnotationType_EditingLockedChange', 'TextUnit_Page',
    'IUIAutomation5', 'ExpandCollapseState',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_AfterParagraphSpacingAttributeId',
    'UIA_RangeValueSmallChangePropertyId',
    'UIA_IsTogglePatternAvailablePropertyId', 'UIA_SizePropertyId',
    'StyleId_Heading4', 'NavigateDirection_LastChild',
    'CoalesceEventsOptions', 'IUIAutomationExpandCollapsePattern',
    'UIA_GridItemColumnSpanPropertyId',
    'UIA_OverlineColorAttributeId', 'UIA_LiveSettingPropertyId',
    'UIA_NativeWindowHandlePropertyId', 'IUIAutomationValuePattern',
    ...
    'ToggleState_Indeterminate', 'UIA_InputDiscardedEventId',
    'AnnotationType_ConflictingChange', 'IUIAutomationElement5',
    'UIA_ToolTipClosedEventId', 'UIA_GridItemColumnPropertyId',
    'ProviderOptions_UseClientCoordinates', 'HeadingLevel6',
    'IUIAutomationDockPattern',
    'UIA_IsInvokePatternAvailablePropertyId',
    'SynchronizedInputType_KeyDown', 'IUIAutomationEventHandler',
    'ScrollAmount', 'UIA_ItemTypePropertyId', 'HeadingLevel9',
    'IUIAutomationElement7', 'UIA_AnnotationTypesAttributeId',
    'UIA_TransformPatternId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_MenuControlTypeId', 'HeadingLevel7',
    'IUIAutomationProxyFactoryEntry', 'UIA_AsyncContentLoadedEventId',
    'UIA_DropTarget_DragEnterEventId',
    'WindowInteractionState_Running', 'WindowVisualState_Minimized',
    'IUIAutomationElement6', 'UIA_LinkAttributeId',
    'DockPosition_Left', 'UIA_ScrollBarControlTypeId',
    'SupportedTextSelection_Single',
    'UIA_WindowWindowVisualStatePropertyId', 'StyleId_Emphasis',
    'UIA_StylesFillPatternColorPropertyId',
    'UIA_IsDragPatternAvailablePropertyId',
    'WindowVisualState_Maximized', 'ExpandCollapseState_LeafNode',
    'ProviderOptions_NonClientAreaProvider', 'TextUnit_Document',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_CheckBoxControlTypeId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'DockPosition_None', 'NotificationProcessing_ImportantAll',
    'UIA_FlowsToPropertyId', 'UIA_TablePatternId',
    'UIA_WindowPatternId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_GridPatternId', 'UIA_TableRowHeadersPropertyId',
    'SynchronizedInputType_KeyUp', 'UIA_MenuOpenedEventId',
    'AnnotationType_InsertionChange', 'IUIAutomationTextRangeArray',
    'UIA_IsSelectionItemPatternAvailablePropertyId', 'UiaChangeInfo',
    'TreeScope_Children', 'AnnotationType_CircularReferenceError',
    'TreeTraversalOptions_PostOrder',
    'ProviderOptions_ServerSideProvider',
    'ScrollAmount_SmallDecrement', 'IUIAutomationTransformPattern',
    'UIA_ProgressBarControlTypeId',
    'UIA_LegacyIAccessibleNamePropertyId', 'IUIAutomationElement3',
    ...
    'IUIAutomationNotificationEventHandler', 'typelib_path',
    'AnnotationType_GrammarError', 'SupportedTextSelection_Multiple',
    ...
    'OrientationType_Vertical', 'StyleId_NumberedList',
    'UIA_SizeOfSetPropertyId', 'IUIAutomationCondition',
    'UIA_ProviderDescriptionPropertyId',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_Selection_InvalidatedEventId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_RangeValueLargeChangePropertyId', 'UIA_ValuePatternId',
    'UIA_LayoutInvalidatedEventId', 'UIA_ChangesEventId',
    'IUIAutomationCustomNavigationPattern',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'AnnotationType_ExternalChange', 'UIA_GridItemRowSpanPropertyId',
    'OrientationType', 'UIA_Drag_DragCancelEventId',
    'UIA_NotificationEventId', 'IUIAutomationProxyFactory',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'DockPosition_Right',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_TogglePatternId', 'IUIAutomationAnnotationPattern',
    'IUIAutomationScrollItemPattern',
    'UIA_AutomationPropertyChangedEventId', 'IUIAutomationTreeWalker',
    'TextEditChangeType_Composition', 'OrientationType_None',
    'IUIAutomationStylesPattern', 'AnnotationType_Highlighted',
    'UIA_MarginLeadingAttributeId',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_EditControlTypeId', 'TextPatternRangeEndpoint_End',
    'WindowInteractionState_NotResponding',
    'StructureChangeType_ChildRemoved',
    'UIA_IsGridPatternAvailablePropertyId', 'UIA_NamePropertyId',
    'StyleId_Quote', 'UIA_BeforeParagraphSpacingAttributeId',
    'ProviderOptions_OverrideProvider',
    'AnnotationType_DeletionChange',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'NotificationProcessing', 'UIA_CapStyleAttributeId',
    'UIA_FlowsFromPropertyId', 'RowOrColumnMajor',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_AnnotationTypesPropertyId',
    'UIA_IndentationFirstLineAttributeId',
    'UIA_IsOffscreenPropertyId', 'UIA_WindowIsModalPropertyId',
    'ScrollAmount_LargeIncrement', 'UIA_LiveRegionChangedEventId',
    'UIA_IsTablePatternAvailablePropertyId', 'TreeScope_Ancestors',
    'UIA_IsSubscriptAttributeId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'UIA_MainLandmarkTypeId', 'UIA_DocumentControlTypeId',
    'UIA_ControllerForPropertyId', 'IUIAutomationRangeValuePattern',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_SliderControlTypeId', 'UIA_Transform2CanZoomPropertyId',
    'UIA_MarginTopAttributeId', 'UIA_DescribedByPropertyId',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_OrientationPropertyId',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'UIA_ToolBarControlTypeId', 'StyleId_Heading5',
    'ZoomUnit_NoAmount', 'AnnotationType_Author',
    'UIA_OverlineStyleAttributeId', 'UIA_FormLandmarkTypeId',
    'WindowVisualState_Normal', 'UIA_WindowIsTopmostPropertyId',
    'UIA_CenterPointPropertyId',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_SelectionSelectionPropertyId', 'UIA_HeaderControlTypeId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_StrikethroughStyleAttributeId',
    'UIA_DockDockPositionPropertyId', 'UIA_ListControlTypeId',
    'UIA_IsTableItemPatternAvailablePropertyId', 'UIA_TextPattern2Id',
    'UIA_CulturePropertyId', 'UIA_CustomLandmarkTypeId',
    'UIA_HelpTextPropertyId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_HasKeyboardFocusPropertyId',
    'UIA_SelectionItemIsSelectedPropertyId', 'TreeScope_None',
    'UIA_ToolTipControlTypeId', 'UIA_ToolTipOpenedEventId',
    'StyleId_BulletedList', 'UIA_IndentationTrailingAttributeId',
    'UIA_Invoke_InvokedEventId', 'UIA_MarginBottomAttributeId',
    ...
    'UIA_StylesPatternId', 'UIA_CaretBidiModeAttributeId',
    'IUIAutomationGridPattern', 'AnnotationType_Sensitive',
    'UIA_MultipleViewSupportedViewsPropertyId', 'WindowVisualState',
    'CoalesceEventsOptions_Disabled', 'UIA_ValueValuePropertyId',
    'Polite', 'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_StyleIdAttributeId', 'UIA_VisualEffectsPropertyId',
    'UIA_UnderlineColorAttributeId',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_IsPeripheralPropertyId', 'UIA_MenuClosedEventId',
    'NavigateDirection_PreviousSibling', 'ZoomUnit_LargeIncrement',
    'UIA_Drag_DragCompleteEventId', 'UIA_ComboBoxControlTypeId',
    'UIA_DropTargetPatternId', 'UIA_SpreadsheetPatternId',
    'UIA_ThumbControlTypeId', 'IUIAutomationDropTargetPattern',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'UIA_DragIsGrabbedPropertyId', 'UIA_GroupControlTypeId',
    'UIA_ImageControlTypeId', 'UIA_InputReachedTargetEventId',
    'PropertyConditionFlags', 'TreeScope_Element',
    'UIA_IsHiddenAttributeId', 'TextUnit_Format',
    'IUIAutomationTextRange', 'UIA_ClassNamePropertyId',
    'TextEditChangeType_None', 'UIA_SpreadsheetItemPatternId',
    'IUIAutomationTextRange2',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'NotificationKind_ItemAdded', 'UIA_RangeValueMinimumPropertyId',
    'DockPosition_Fill', 'IUIAutomationTextPattern2',
    'ZoomUnit_SmallIncrement',
    'UIA_ScrollHorizontalViewSizePropertyId', 'StructureChangeType',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_FullDescriptionPropertyId', 'CUIAutomation',
    'UIA_SpinnerControlTypeId', 'AnnotationType_UnsyncedChange',
    'UIA_GridItemPatternId', 'UIA_CustomNavigationPatternId',
    'UIA_ScrollItemPatternId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_OutlineStylesAttributeId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'PropertyConditionFlags_IgnoreCase', 'UIA_StatusBarControlTypeId',
    'UIA_InputReachedOtherElementEventId', 'UIA_MenuBarControlTypeId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_TransformCanRotatePropertyId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'ScrollAmount_SmallIncrement', 'UIA_ItemStatusPropertyId',
    'ProviderOptions', 'NotificationKind_ActionCompleted',
    'UIA_AnimationStyleAttributeId', 'UIA_ButtonControlTypeId',
    'UIA_StrikethroughColorAttributeId', 'OrientationType_Horizontal',
    'AnnotationType_TrackChanges', 'IUIAutomationObjectModelPattern',
    'UIA_LegacyIAccessibleRolePropertyId', 'UIA_IsActiveAttributeId',
    'Off', 'TreeTraversalOptions_LastToFirstOrder',
    'UIA_SayAsInterpretAsMetadataId', 'RowOrColumnMajor_RowMajor',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_DragDropEffectsPropertyId', 'TreeScope_Subtree',
    'ProviderOptions_ClientSideProvider',
    'ExpandCollapseState_Collapsed', 'AnnotationType_Unknown',
    'UIA_IsObjectModelPatternAvailablePropertyId', 'TextUnit_Line',
    'TreeScope_Parent', 'IUIAutomation3',
    'IUIAutomationGridItemPattern', 'UIA_CalendarControlTypeId',
    'TextUnit', 'UIA_IsEnabledPropertyId', 'UIA_SummaryChangeId',
    'UIA_Transform2ZoomMaximumPropertyId', 'UIA_SystemAlertEventId',
    'StructureChangeType_ChildrenInvalidated',
    'ProviderOptions_UseComThreading', 'DockPosition_Top',
    'HeadingLevel4', 'UIA_IsContentElementPropertyId',
    'UIA_IsTextPatternAvailablePropertyId',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_IsItalicAttributeId', 'UIA_AnnotationObjectsAttributeId',
    'UIA_AutomationFocusChangedEventId',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_TransformPattern2Id', 'IUIAutomation',
    'IUIAutomationElement8', 'UIA_StylesFillColorPropertyId',
    'UIA_DragGrabbedItemsPropertyId', 'IUIAutomationTextPattern',
    'AnnotationType_Mathematics', 'HeadingLevel3',
    'UIA_TreeItemControlTypeId', 'AnnotationType_Footnote',
    'UIA_StylesExtendedPropertiesPropertyId',
    'WindowInteractionState', 'ScrollAmount_LargeDecrement',
    'UIA_ValueIsReadOnlyPropertyId', 'UIA_AccessKeyPropertyId',
    'AnnotationType_Header', 'UIA_FontNameAttributeId',
    'IUIAutomationElement2',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_AutomationIdPropertyId', 'TreeScope_Descendants',
    'TreeTraversalOptions', 'UIA_TransformCanResizePropertyId',
    'HeadingLevel1', 'UIA_Selection2CurrentSelectedItemPropertyId',
    'CoalesceEventsOptions_Enabled',
    'AnnotationType_AdvancedProofingIssue', 'TextEditChangeType',
    'IUIAutomationFocusChangedEventHandler', 'UIA_PaneControlTypeId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_LegacyIAccessiblePatternId', 'DockPosition',
    'UIA_AnnotationObjectsPropertyId', 'UIA_IsPasswordPropertyId',
    'IUIAutomationAndCondition',
    'UIA_ActiveTextPositionChangedEventId',
    'UIA_ExpandCollapsePatternId', 'UIA_TextEditPatternId',
    'UIA_RangeValueMaximumPropertyId', 'UIA_TextControlTypeId',
    'IUIAutomationElement', 'UIA_RuntimeIdPropertyId',
    'UIA_AriaPropertiesPropertyId', 'AnnotationType_Comment',
    ...
    'UIA_DragDropEffectPropertyId', 'TextUnit_Word',
    'UIA_ClickablePointPropertyId', 'IUIAutomationTablePattern',
    'ConnectionRecoveryBehaviorOptions', 'IUIAutomationWindowPattern',
    ...
    'UIA_FillTypePropertyId', 'IUIAutomation4', 'UIA_InvokePatternId',
    'UIA_DragPatternId', 'UIA_SearchLandmarkTypeId',
    'UIA_TabControlTypeId', 'IUIAutomationSpreadsheetPattern',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'StructureChangeType_ChildAdded', 'UIA_FontWeightAttributeId',
    'AutomationElementMode', 'ExpandCollapseState_Expanded',
    'UIA_StructureChangedEventId',
    'IUIAutomationTextEditTextChangedEventHandler', 'HeadingLevel5',
    'StyleId_Heading6', 'UIA_CaretPositionAttributeId',
    'IUIAutomationDragPattern', 'NotificationKind_Other',
    'UIA_LegacyIAccessibleStatePropertyId', 'TreeScope',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_SelectionPatternId', 'UIA_WindowCanMinimizePropertyId',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_BackgroundColorAttributeId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'StructureChangeType_ChildrenBulkRemoved',
    'NotificationKind_ItemRemoved', 'UIA_IsReadOnlyAttributeId',
    'NavigateDirection_Parent', 'UIA_TextFlowDirectionsAttributeId',
    'NavigateDirection_FirstChild', 'UIA_TableItemPatternId',
    'AnnotationType_Endnote', 'UIA_IsDialogPropertyId',
    'UIA_LocalizedControlTypePropertyId',
    'IUIAutomationItemContainerPattern',
    'IUIAutomationEventHandlerGroup', 'UIA_StyleNameAttributeId',
    'IUIAutomationTextChildPattern',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_VirtualizedItemPatternId', 'UIA_SynchronizedInputPatternId',
    'UIA_RangeValueValuePropertyId', 'UIA_NavigationLandmarkTypeId',
    ...
    'UIA_GridColumnCountPropertyId', 'UIA_DockPatternId',
    'UIA_Text_TextChangedEventId', 'IUIAutomationTransformPattern2',
    'PropertyConditionFlags_None', 'UIA_HeaderItemControlTypeId',
    'UIA_TextEdit_TextChangedEventId', 'UIA_DataItemControlTypeId',
    'UIA_RotationPropertyId', 'UIA_HorizontalTextAlignmentAttributeId'
]

_check_version('1.3.0', 1708065734.128830)
